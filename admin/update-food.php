...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        //get the value based on query exuecuted
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        //check whether the image is uploadede or not
                        if($upload==false)
                        {
                            //failed to upload
                ...
                {
                    $image_name = $current_image;//default image whenbutton is not clicked
                }


                //4.update he food in database 
